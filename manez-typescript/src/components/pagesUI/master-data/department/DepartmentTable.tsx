...
const DepartmentTable = () => {
  ...
  const {
    ...
    handleSearchChange,
    setRows,
  } = useMaterialTableHook<IDepartment | any>(departmentData, 10);
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      try {
        ...
        const mapped: IDepartment[] = array.map((item: any) => ({
          id: item.id,
          name: item.name,
    ...
    <>
                  ...
                  <TableBody className="table__body">
                    ...
                    {!loading &&
                      ...
                      paginatedRows.map((row, index) => (
                        ...
                        >
                          <TableCell className="table__name">
                            {row?.name}
                          </TableCell>
                          <TableCell className="table__description">
                            {row?.description}
                          </TableCell>
      ...
      {modalDeleteOpen && (
        <DeleteModal
          ...
          handleDeleteFunc={handleDeleteDepartment}
          deleteId={deleteId}
        />
      )}
    </>
